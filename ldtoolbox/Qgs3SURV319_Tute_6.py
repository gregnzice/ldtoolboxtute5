...
class SURV319Tute6(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'surv319tute6'
    def tr(self, string):
        return QCoreApplication.translate('surv319tute6', string)
    ...
    def displayName(self):
        ...
        """
        return self.tr('SURV319 Tute 6')
    def shortHelpString(self):
        file=os.path.realpath(__file__)
        file = os.path.join(os.path.dirname(file),'Qgs3SURV319_Tute_6.help')
